              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 p-6">
                  <div className="relative flex items-center justify-center">
                    {/* Cercle d'animation en fond */}
                    <div className="absolute h-16 w-16 animate-ping rounded-full bg-[#0a66c2] opacity-20"></div>

                    {/* Logo LinkedIn */}
                    <svg
                      className="relative h-12 w-12 animate-pulse fill-[#0a66c2]"
                      viewBox="0 0 24 24"
                    >
