...
from core.chrome.run_chrome import run_chrome
from locks import user_lock
from query.linkedin.get_job_title import get_job_title
from query.get_post_instruction import get_post_instruction
...
def start_auto(cabinet_name=None, uid=None, post=None, title=None, job=None, job_id=None, details=None, config_db=None, mode=None,
    ...
    while True:
        try:
            from query.linkedin.check_start import check_start
            check_start()
